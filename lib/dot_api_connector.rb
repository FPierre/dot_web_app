...
class DotApiConnector
  ...
  def create_user_session attributes = {}
    process { resource.post(route_for('sign_in'), attributes.to_json, headers(attributes)) }
  end
  ...
  def update_sarah_state attributes = {}
    process { resource.patch(route_for('settings'), attributes.to_json, headers) }
  end

  def update_twitter_state attributes = {}
    process { resource.patch(route_for('settings'), attributes.to_json, headers) }
  end

  def update_reminders_state attributes = {}
    process { resource.patch(route_for('settings'), attributes.to_json, headers) }
  end

  def update_weather_state attributes = {}
    process { resource.patch(route_for('settings'), attributes.to_json, headers) }
  end
