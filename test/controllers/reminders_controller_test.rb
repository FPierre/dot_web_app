...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { body: @reminder.body, title: @reminder.title, user_id: @reminder.user_id } }
    end

    assert_redirected_to reminder_path(Reminder.last)
  end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { body: @reminder.body, title: @reminder.title, user_id: @reminder.user_id } }
    assert_redirected_to reminder_path(@reminder)
  end
